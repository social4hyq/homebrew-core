class LlvmAT21 < Formula
  ...
  def post_install
    ...
    # invocation or ELF magic parsing needed.
    ...
    shims.each do |shim_name, target|
      ...
      File.write(shim_path, <<~SH)
        ...
        # LLD --code-sign injects .codesign at link time.
    ...
    ohai "Generated cc/c++ shims in #{HOMEBREW_PREFIX}/bin (LD_LIBRARY_PATH + LLD --code-sign)"
  end
