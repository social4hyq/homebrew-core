class OpenjdkAT21 < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "40a375b6ab3ed5f8919fa0f47ce28397a59223d05b75f3560e45d4bc7e77bf14"
  end
  ...
  patch do
    file "Patches/openjdk@21/0002-mark-libjvm-global.patch"
  end
  ...
  patch do
    file "Patches/openjdk@21/0003-mark-libawt-headless-global.patch"
  end
