class Llm < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "32a6d6ce35eb4237ad54926044eaaae1399605e955a7f107ccde93d0b2cb09b8"
  end
  ...
  test do
    assert_match "Usage:", shell_output("#{bin}/llm --help")
