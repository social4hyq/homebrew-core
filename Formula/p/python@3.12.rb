class PythonAT312 < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "3107cd14afde804250bb010131650ec8c6c9764961345bdfd4fc897654050946"
  end
  ...
  def install
    ...
    inreplace "configure", /PLATFORM_TRIPLET=`grep -v '\^#' conftest\.out.*`/, 'PLATFORM_TRIPLET="aarch64-linux-musl"'
    inreplace "Lib/sysconfig.py", "def get_platform():", "def get_platform():\n    return \"linux-aarch64\""
    ...
    system "patchelf", "--add-needed", "libmusl_compat.so", bin/"python3.12"
