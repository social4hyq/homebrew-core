class LlvmAT22 < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "c959b5243ec8947020c5b12af88fce03a736bf358b6e67ce9ee12f0712efbb1f"
  end
  ...
  patch do
    file "Patches/llvm@22/0002-cmake4-if-parser-compat.patch"
  end
