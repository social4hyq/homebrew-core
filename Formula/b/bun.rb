class Bun < Formula
  ...
  #
  # v1.4.0, not bun@1.4's 1.3.14: Patches/bun/ stamps
  # src/node-fallbacks/bun.lock as lockfileVersion 2, and the textual bun.lock
  # parser only exists from bun 1.4.0 onwards — 1.3.14 reads bun.lockb and dies
  # with "Unknown lockfile version" (PR #686's first CI run). bun@1.4 can use
  # 1.3.14 because it carries no such patch.
