class Zstd < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "709be2867d9afa4091f8dd16ad952ddfa1d1913b9ce99bda80b38c1800cd747c"
  end
  ...
  def install
    inreplace "lib/common/zstd_deps.h", "!defined(__ANDROID__)", "!defined(__ANDROID__) && !defined(__OHOS__)"
    inreplace "lib/dictBuilder/cover.c", "!defined(__ANDROID__)", "!defined(__ANDROID__) && !defined(__OHOS__)"
