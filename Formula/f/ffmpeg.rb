class Ffmpeg < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "2e97163f5fa1541120d010a448b9dbdea387e8a44862317826b5a22769d6d6a4"
  end
  ...
  # sdl2 has not yet been ported to OHOS, so only enable on macOS
  on_macos do
    depends_on "sdl2"
  end

  on_linux do
    # fix fatal error 'vulkan_beta.h' file not found on OHOS
