class OpenjdkAT25 < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "034af9ab9cead6b875583b58926339da8f3429be389aa9a7a98369a67dc1a8b0"
  end
  ...
  patch do
    file "Patches/openjdk@25/0002-mark-libjvm-global.patch"
  end
  ...
  patch do
    file "Patches/openjdk@25/0003-mark-libawt-headless-global.patch"
  end
