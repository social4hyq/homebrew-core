class PhpAT82 < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "05832e2d7fa4913a9b3ad3daf21c99bca1e82a73b0ef911363a8b8e741e0ad5e"
  end
  ...
  def install
    ...
    ENV["ac_cv_phpdbg_userfaultfd_writefault"] = "no"
