class PythonAT313 < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "08fda5dfbeef2802d4a73e37795e2d38ad1847d0bca3850aca44c7c23569eecb"
  end
  ...
  def install
    ...
    # Hardcoding aarch64-linux-musl triplet to reuse musl pip wheels
    inreplace "configure", 'PLATFORM_TRIPLET="${PLATFORM_TRIPLET#PLATFORM_TRIPLET=}"', 'PLATFORM_TRIPLET="aarch64-linux-musl"'
    inreplace "configure", 'MULTIARCH=$($CC --print-multiarch 2>/dev/null)', 'MULTIARCH="aarch64-linux-musl"'
    inreplace "Lib/sysconfig/__init__.py", "def get_platform():", "def get_platform():\n    return \"linux-aarch64\""
    ...
    system "patchelf", "--add-needed", "libmusl_compat.so", bin/"python3.13"
