class OhosCompatShim < Formula
  ...
  bottle do
    root_url "https://atomgit.com/social4hyq/homebrew-core/releases/download/ohos-compat-shim-v0.2.9-r3"
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_ohos: "4b633c4a7443ad437a83edfef25d1653d2c3262b7d973227074333312df37327"
  end
