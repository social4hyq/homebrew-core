class Vim < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "a276926b47ff0bc13772cc73e5c670705462be84e267981c14aedfa36a0bb680"
  end
  ...
  def install
    ...
    inreplace share/"vim/vim92/defaults.vim" do |s|
      s.gsub! "set mouse=a", "set mouse="
      s.gsub! "set mouse=nvi", "set mouse="
    end
  end
