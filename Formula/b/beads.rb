class Beads < Formula
  ...
  url "https://github.com/steveyegge/beads/archive/refs/tags/v1.3.0.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "3872a441c157592627718d0b84e2d6bb153d015f750e265ed5cbf0c0049b13d1"
  end
