class OhosSdkAT260018 < Formula
  ...
  # prefix, and doing so would shadow binaries already shipped by `ohos-sdk`.
  #
  # Keep the string form below. Do NOT replace it with
  # `keg_only :versioned_formula`: that makes keg-only conditional on the
  # unversioned counterpart being installed, and brew will link this formula
  # into the default prefix once the main formula is absent — which is
