class Php < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "6f8cf51546aa78cf18d7d0306dd461b8376c161a7b06e3c24edc3467542a6d69"
  end
  ...
  def install
    ...
    # OHOS has no system libintl.h, so always point gettext detection at the
    # Homebrew gettext (upstream relies on a glibc system header on Linux).
