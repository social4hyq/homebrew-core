class Nginx < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ohos: "a033c5dd0155404db549bdcd2b83d4b807f040bb30b43a97cb2e143a266d9aa6"
  end
  ...
  patch do
    file "Patches/nginx/0001-support-ohos.patch"
  end
